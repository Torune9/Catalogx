<x-layouts.profileLayout>
    <div class="flex flex-row items-center overflow-hidden rounded-2xl gap-2">
        <picture class="h-screen w-3/5">
            <div class="h-full w-full">
                <img class="h-full" src="{{ asset('img/sepatu2.jpg') }}" alt="">
            </div>
        </picture>
        <div class="w-2/5 h-screen flex flex-col justify-center relative">
            <div class="p-2">
                <h1 class="text-6xl font-deca font-black">Rahman<span
                        class="text-blue-800 inline-block">Nurhayadi</span>
                </h1>
            ...
            <button
                class="absolute bottom-4 right-4 p-2 bg-blue-800 w-40 rounded-md text-white font-poppins font-semibold">
                Edit
            </button>
        </div>
    </div>
